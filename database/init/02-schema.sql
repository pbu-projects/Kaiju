...
INSERT INTO locations (name, address_line, city, state, geom) VALUES
('Main Pantry', '123 Main St', 'Bountiful', 'UT', ST_GeographyFromText('POINT(-111.8804 40.8906)')),
('North Sorting Facility', '456 Center St', 'Centerville', 'UT', ST_GeographyFromText('POINT(-111.8722 40.9180)')),
('Ogden Warehouse', '789 Far Ave', 'Ogden', 'UT', ST_GeographyFromText('POINT(-111.9738 41.2230)'));
