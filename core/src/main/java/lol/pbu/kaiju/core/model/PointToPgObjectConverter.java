...
@Singleton
public class PointToPgObjectConverter implements TypeConverter<Point, PGobject> {

    @Override
    public Optional<PGobject> convert(Point object, Class<PGobject> targetType, ConversionContext context) {
        if (object == null) {
